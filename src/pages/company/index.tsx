...
import { Meta, Company } from "../../utils/model";
  ...
  if (isLoading)
    return (
      <main className="2xl:max-w-[1720px] xl:max-w-[1240px] max-w-[358px] mx-auto px-0 sm:px-6 darok:text-gray-100 h-auto animate-pulse">
        <div className="mt-12 h-[26px] bg-gray-200 rounded-xl w-[70%]"></div>
        <div className="mt-6 h-[20px] bg-gray-200 rounded-xl w-[60%]"></div>
        <div className="mt-[16px] bg-gray-200 rounded-xl h-[40px] w-[60%]"></div>
        <div className="mt-[24px] bg-gray-200 rounded-xl h-[288px] w-full"></div>
        <div className="mt-[24px] bg-gray-200 rounded-xl h-[389px] w-full"></div>
        <div className="mt-[24px] bg-gray-200 rounded-xl h-[600px] w-full"></div>
        <div className="mt-[24px] bg-gray-200 rounded-xl h-[600px] w-full"></div>
      </main>
    );
          ...
          <div className="w-full gap-[28px]">
            ...
            <div className="w-full grid lg:grid-cols-3 min-[720px]:grid-cols-2 grid-cols-1 sm:gap-8 mt-2">
              <div className="w-full block ">
                    ...
                    <div className="mt-[-10px]">
                      ...
                      >
                        <g clipPath="url(#clip0_741_15413)">
                          ...
                          <path d="M55.75 9H111.5V33H55.75V9Z" fill="#EBEBEB" />
                          <path
                      ...
                      >
                        <g clipPath="url(#clip0_741_14829)">
                          ...
                          <path d="M15.75 9H31.5V33H15.75V9Z" fill="#EBEBEB" />
                          <path
                            d="M30 9V33H33V9H30Z"
                            fill="#D3D3D3"
                      ...
                      >
                        <g clipPath="url(#clip0_1_1278)">
                          ...
                          <path d="M44.75 7H89.5V31H44.75V7Z" fill="#EBEBEB" />
                          <path
                            d="M88 7V31H91V7H88Z"
                            fill="#D3D3D3"
                          ...
                          <path d="M89.5 7H134.25V31H89.5V7Z" fill="#EBEBEB" />
                          <path
                ...
                <div className="justify-between md:flex min-[720px]:block sm:flex py-[6px]">
                  <div className=" lg:w-full w-[150px] justify-between">
                    <p className="text-[14px] text-[#101011] ">50-Day Range</p>
                  </div>
                  <div className="flex gap-[16px]  items-center">
                    <p className="font-semibold text-[14px] py-2">$289.52</p>
                    <div className="mt-[-10px]">
                ...
                <div className="justify-between md:flex min-[720px]:block sm:flex py-[6px]">
                  <div className=" lg:w-full w-[150px] justify-between">
                    <p className="text-[14px] text-[#101011] ">52-Week Range</p>
                  </div>
                  <div className="flex gap-[16px]  items-center">
                    <p className="font-semibold text-[14px] py-2">$289.52</p>
                    <div className="mt-[-10px]">
                ...
                <div className="justify-between flex py-[6px]">
                  ...
                  <div className="flex gap-[16px] items-center">
                    <p className="font-semibold text-[14px]">$923.15 billion</p>
                  </div>
                </div>
                <div className="justify-between flex py-[6px]">
                  <div>
                ...
                <div className="justify-between flex py-[6px]">
                  <div>
                    <p className="text-[14px] text-[#101011]">Average Volume</p>
                  </div>
                  <div className="flex gap-[16px] items-center">
                    <p className="font-semibold text-[14px]">$923.15 billion</p>
                  </div>
              ...
              <div className="w-full block h-[196px]">
                ...
                <div className="justify-between flex py-[6px]">
                  <div>
                    <p className="text-[14px] text-[#101011]">Divident Yield</p>
                  </div>
                  <div className="flex gap-[16px] items-center">
                    <p className="font-semibold text-[14px]">$923.15 billion</p>
                  </div>
              ...
              <div className="w-full block h-[196px]">
                ...
                <div className="justify-between flex py-[6px]">
                  ...
                  <div className="flex gap-[16px] items-center">
                    <p className="font-semibold text-[14px]">294.23 - 297.48</p>
                  </div>
                </div>
                <div className="justify-between flex py-[6px]">
                  <div>
