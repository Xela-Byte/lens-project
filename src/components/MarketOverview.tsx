	...
	return (
		<div className="md:mt-16 mt-[28px]">
			<div className="flex items-center">
				<h1 className="text-[#101011] md:text-[26px] text-[22px] font-medium">Market overview</h1>
					...
					<div className="mb-4 border-b border-[#EBEBEB]">
						<ul className="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
							<li className="mr-2" role="presentation">
								<button className="inline-block md:px-2 px-0 h-[38px] border-b-2 border-[#027EF4] bg-gradient-to-b from-[#027EF400] to-[#027EF433] rounded-t-lg md:text-[14px] text-[12px] text-[#027EF4]" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Biggest Gainers</button>
							</li>
							<li className="mr-2" role="presentation">
								<button className="inline-block md:px-2 px-0 h-[38px] mx-4 border-b-2 border-transparent rounded-t-lg md:text-[14px] text-[12px] hover:text-[#027EF4] hover:border-[#027EF4]" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Biggest Losers</button>
							</li>
							<li className="mr-2" role="presentation">
								<button className="inline-block md:px-2 px-0 h-[38px] border-b-2 border-transparent rounded-t-lg md:text-[14px] text-[12px] hover:text-[#027EF4] hover:border-[#027EF4] " id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Most Activities</button>
							</li>
						</ul>
					</div>
						...
						<>
							<div className="w-full md:grid grid-cols-4 gap-5 hidden">
								<div className="relative overflow-x-auto col-span-3">
									<table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-xl">
										...
										<tbody>
											{data.map((c: Company) => (
												<tr className="cursor-pointer bg-[#FAFAFA] text-[#101011] text-[14px] hover:bg-[#EAEAEA]" onClick={() => navigate(`/${c.attributes.slug}`)}>
							...
							<div className="md:hidden w-full hover:border-collapse block">
								{data.map((c: Company) => (
									<>
										<table className="w-full content-stretch my-2">
											<tr className="text-left cursor-pointer bg-[#FAFAFA] text-[#101011] text-[14px] hover:bg-[#EAEAEA]" onClick={() => navigate(`/${c.attributes.slug}`)}>
											...
											<tr className="cursor-pointer bg-[#FAFAFA] text-[#101011] text-[14px] hover:bg-[#EAEAEA]" onClick={() => navigate(`/${c.attributes.slug}`)}>
												<th scope="row" className="text-left  py-4 whitespace-nowrap">
													Price
												</th>
												<td className="text-right py-4">
													${c.attributes.stockPrice}
								...
								<div className="w-full  flex justify-between">
									<p className="text-left  py-4 whitespace-nowrap font-medium">Graph</p>
									<select>
