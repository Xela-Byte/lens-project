export function ArticleSkeleton() {
	return (
		<main className="2xl:max-w-[1720px] xl:max-w-[1240px] max-w-[358px] mx-auto px-0 sm:px-6 darok:text-gray-100 h-auto animate-pulse">
			<div className="mt-[24px] h-[26px] bg-gray-200 rounded-xl w-[60%]"></div>
			<div className="mt-[24px] h-[20px] bg-gray-200 rounded-xl w-[20%]"></div>
			<div className="mt-[24px] bg-gray-200 rounded-xl h-[32px] w-[70%]"></div>
			<div className="mt-[24px] h-[22px] bg-gray-200 rounded-xl w-[60%]"></div>
			<div className="w-full grid grid-cols-4 gap-5 mt-6">
				<div className="w-full h-auto col-span-3">
					<div role="status" className="flex items-center justify-center h-96 w-full bg-gray-300 rounded-lg animate-pulse">
					...
					<div role="status" className="space-y-2.5 animate-pulse w-full mt-8">
