...
export default function FormSubmit({
  ...
  const token = process.env.REACT_APP_PUBLIC_STRAPI_FORM_SUBMISSION_TOKEN;
        ...
        <div className="flex flex-row">
          {successMessage ? (
            ...
            <>
              ...
              <button
                type="button"
                className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 darok:bg-violet-400 darok:text-gray-900"
