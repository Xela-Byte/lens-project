...
function FooterLink({ url, text }: FooterLink) {
  ...
  return (
    <li className="flex pr-[10px]">
      <Link
        to={url}
        className={`hover:darok:text-violet-400 max-md:text-[14px] ${pathname === url && "darok:text-violet-400 darok:border-violet-400"
          }}`}
      >
        {text}
      </Link>
      ...
      <div className="2xl:max-w-[1720px] xl:max-w-[1240px] sm:max-w-full max-w-[358px]  mx-auto space-y-6 divide-y divide-gray-400 md:space-y-6 divide-opacity-50">
        ...
        <div className="w-full  border-none  gap-1">
          ...
          <div className="w-full flex justify-center items-center">
            <p className="text-[#717172] text-[12px] leading-[20px] font-normal">©WallStreetLens, 2023</p>
          </div>
        </div>
      </div>
    </footer>
