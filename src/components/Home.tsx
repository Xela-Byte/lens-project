...
export default function Home() {
  return (
    <main className="darok:bg-black 2xl:max-w-[1720px] xl:max-w-[1240px] sm:max-w-full max-w-[358px] mx-auto px-0 sm:px-6 darok:text-gray-100 min-h-screen">
      ...
      <div className=" w-full h-auto 2xl:max-w-[1720px] xl:max-w-[1240px] max-w-[358px] sm:max-w-full 
      ...
      >
        <img className="2xl:flex hidden w-[480px] z-20 h-auto absolute bottom-0 right-[30%]" src="/vector-122.svg" />
        <img className="2xl:hidden flex w-auto z-20 h-full absolute top-0 left-[10%] max-sm:left-0" src="/vector-302.svg" />
        <div className=" min-w-[310px] flex justify-center mx-right z-10 ">
          <div className="w-full">
            <h1 className="2xl:hidden flex max-md:hidden text-[36px] leading-[44px] font-semibold text-white">
              Find Information  <br />about stocks and  <br />investments here
            </h1>
            <h1 className="flex md:hidden text-[26px] leading-[44px] font-semibold text-white">
              Find Information about<br /> stocks and investments  <br />here
            </h1>
            <h1 className="2xl:flex hidden text-[36px]  leading-[44px] font-semibold text-white">
              Find Information about stocks and  investments <br />here
            </h1>
            <div className="w-full">
      ...
      <div className="md:mt-16 mt-[28px]">
        <div className="flex items-center">
          <h1 className="text-[#101011] text-[26px] font-medium">Market Indicies</h1>
      ...
      <div className="mt-20">
        <div className="flex items-center">
          <h1 className="text-[#101011] text-[26px] font-medium">Latest market news</h1>
          <ArrowDRShirtIcon size={32} className="ml-3" />
        </div>
      ...
      <div className="mt-20 hidden bg-black w-full h-[166px] rounded-xl md:flex justify-center items-center relative p-[32px]">
        <img className="h-[166px] w-auto absolute top-0 right-[20%]" src="/vector-300.svg" />
        <img className="h-[166px] w-auto absolute bottom-0 right-0" src="/vector-301.svg" />
      ...
      <div className="mt-20 md:block hidden">
        <div className="flex items-center">
          <h1 className="text-[#101011] text-[22px] font-medium">Most Popular</h1>
