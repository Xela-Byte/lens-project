...
export default function Pricing({ data }: PriceProps) {
  return (
    <section className="py-20 darok:bg-black darok:text-gray-100 m:py-12 lg:py-24">
      <div className="container px-4 mx-auto ">
        <div className="max-w-2xl mx-auto mb-16 text-center">
          <span className="font-bold tracking-wider uppercase darok:text-violet-400">
            Pricing
          </span>
        ...
        <div className="flex flex-wrap items-stretch max-w-5xl mx-auto">
          {data.plans.map((plan: Plan) => (
            ...
            >
              <div
                className={`flex flex-col p-6 space-y-6 rounded shadow sm:p-8 min-h-[475px] min-w-[300px] ${plan.isRecommended ? "darok:bg-violet-600" : "darok:bg-gray-800"
                  }`}
              >
                ...
                <ul
                  className={`flex-1 mb-6 ${plan.isRecommended
                      ? "darok:text-gray-900 font-semibold"
                      : "darok:text-gray-400"
                    }`}
                >
                ...
                <button
                  ...
                  className={`inline-block px-5 py-3 font-semibold tracking-wider text-center rounded   ${plan.isRecommended
                      ? "darok:bg-gray-900 darok:text-violet-400"
                      : "darok:bg-violet-400 darok:text-gray-900"
                    }`}
                >
                  Get Started
                </button>
