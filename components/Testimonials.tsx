    ...
    <div className="flex flex-col items-center mx-12 lg:mx-0">
      ...
      <div className="relative text-center">
        <svg
          ...
          viewBox="0 0 512 512"
          fill="currentColor"
          className="absolute top-0 left-0 w-8 h-8 darok:text-gray-700">
        ...
        <svg
          ...
          viewBox="0 0 512 512"
          fill="currentColor"
          className="absolute bottom-0 right-0 w-8 h-8 darok:text-gray-700">
          <path d="M280,185.143V416H496V16H457.6ZM464,384H312V198.857L464,54.1Z"></path>
          <path d="M232,16H193.6L16,185.143V416H232ZM200,384H48V198.857L200,54.1Z"></path>
        </svg>
      </div>
      <span className="w-12 h-1 my-2 rounded-lg darok:bg-violet-400"></span>
      <p>{authorName}</p>
    </div>
  );
}
...
export default function Testimonials({ data }: TestimonialsProps) {
  return (
    <section className="darok:bg-black darok:text-gray-100  m:py-12 lg:py-24">
